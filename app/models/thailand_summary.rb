class ThailandSummary < ApplicationRecord
  ...
  def confirmed_deaths_from_foreign_countries_add_today
    (confirmed_deaths_from_foreign_countries - (yesterday&.confirmed_deaths_from_foreign_countries || 0)).non_negative
  end
  ...
  def as_json(options = {})
    if options[:api]
      ...
      json[:confirmed_deaths_from_foreign_countries_add_today] = confirmed_deaths_from_foreign_countries_add_today
